...
export default function OverviewPage() {
  ...
  if (error) return <p className="p-6 text-red-600">Erreur lors du chargement des statistiques.</p>;
  if (!data) return null;

  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-slate-900">Tableau de bord - Vue d'ensemble</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <div>
            <div className="text-2xl font-bold">{data.drivers}</div>
        ...
        <Card>
          ...
          <div>
            <div className="text-2xl font-bold">{(data.finance.paidAmount).toLocaleString()} FCFA</div>
        ...
        <Card>
          ...
          <div>
            <div className="text-2xl font-bold">{data.finance.recoveryRate}%</div>
...
function AuditLogsList() {
  ...
  return (
    <div className="space-y-4">
      {data.map((log) => (
        <div key={log.id} className="flex items-start space-x-4 text-sm border-l-2 border-slate-200 pl-4 py-1 hover:border-blue-400 transition-colors">
          <div className="min-w-[140px] text-xs text-slate-400 font-mono">
